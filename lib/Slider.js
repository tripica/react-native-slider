...
return(
_react2.default.createElement(_reactNative.View,{style:this.props.containerStyle,__source:{fileName:_jsxFileName,lineNumber:334}},
_react2.default.createElement(_reactNative.View,_extends({},other,{style:[mainStyles.container,style],onLayout:this._measureContainer,__source:{fileName:_jsxFileName,lineNumber:335}}),
_react2.default.createElement(_reactNative.View,{
style:[{backgroundColor:maximumTrackTintColor},mainStyles.track,trackStyle],
onLayout:this._measureTrack,__source:{fileName:_jsxFileName,lineNumber:336}}),
_react2.default.createElement(_reactNative.Animated.View,{style:[mainStyles.track,trackStyle,minimumTrackStyle],__source:{fileName:_jsxFileName,lineNumber:339}}),

_react2.default.createElement(_reactNative.Animated.View,{
onLayout:this._measureThumb,
style:[
{backgroundColor:thumbTintColor,marginTop:-(trackSize.height+thumbSize.height)/2},
mainStyles.thumb,thumbStyle,_extends({left:thumbLeft},valueVisibleStyle)],__source:{fileName:_jsxFileName,lineNumber:341}}),


_react2.default.createElement(_reactNative.View,_extends({
style:[defaultStyles.touchArea,touchOverflowStyle]},
this._panResponder.panHandlers,{__source:{fileName:_jsxFileName,lineNumber:348}}),
...
_react2.default.createElement(_reactNative.View,{key:i,style:{top:containerSize.height/2+trackSize.height/2,position:'absolute'},__source:{fileName:_jsxFileName,lineNumber:356}},
_react2.default.createElement(_reactNative.View,{
style:[
{backgroundColor:maximumTrackTintColor,marginTop:-(trackSize.height+GRADUATION_HEIGHT)/2},
mainStyles.graduation,graduationStyle,_extends({left:_this2._getGraduationOffset(i)},valueVisibleStyle)],__source:{fileName:_jsxFileName,lineNumber:357}}),
...
{width:_this2.state.legendWidth[i],left:_this2._getGraduationOffset(i)-_this2.state.legendWidth[i]/2}],__source:{fileName:_jsxFileName,lineNumber:362}},
_this2._renderGraduationLabel(i))):

showBarAtIgnoredGraduation&&
_react2.default.createElement(_reactNative.View,{key:i,style:{top:containerSize.height/2+trackSize.height/2,position:'absolute'},__source:{fileName:_jsxFileName,lineNumber:369}},
_react2.default.createElement(_reactNative.View,{style:_extends({backgroundColor:maximumTrackTintColor,marginTop:-(trackSize.height+GRADUATION_HEIGHT-2)/2,width:2,height:GRADUATION_HEIGHT-2,left:_this2._getGraduationOffset(i)},valueVisibleStyle),__source:{fileName:_jsxFileName,lineNumber:370}})));}),
...
return(
_react2.default.createElement(_reactNative.Text,{style:[{textAlign:'center'},_this3.props.graduationLabelStyle],__source:{fileName:_jsxFileName,lineNumber:653}},
_this3.props.graduationLabel(index)));


}
return _react2.default.createElement(_reactNative.View,{__source:{fileName:_jsxFileName,lineNumber:658}});
};this.
...
pointerEvents:"none",__source:{fileName:_jsxFileName,lineNumber:671}}));
